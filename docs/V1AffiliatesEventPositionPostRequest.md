...
**event_betting_market_position_id** | **i64** | The event betting market position to build the cart for. | 
...
**use_cartoon_images** | Option<**bool**> | When true, swaps default operator/jersey imagery for cartoon variants. | [optional]
